...
# tgt_host = "llvm -mcpu=skylake"
# Change it to respective GPU if gpu is enabled Ex: cuda, opencl, rocm
tgt = "llvm -mtriple=riscv64-unknown-linux-gnu -mcpu=rocket-rv64"
# tgt = "llvm -mtriple=riscv64-unknown-elf"
# tgt = "llvm -mcpu=skylake"
...
# temp = utils.tempdir()
# path = temp.relpath("riscv.tar")
path = "riscv.so"
specialized = cc.cross_compiler("/home/hye/soft/riscv/new_install/bin/riscv64-unknown-linux-gnu-g++", ["-mabi=lp64"])
fadd.export_library(path, specialized)
# fadd.save("riscv.o")
# cc.create_shared(path, ["riscv.o"])
# print(temp.listdir())
