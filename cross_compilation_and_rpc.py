...
if local_demo:
    ...
    target = "llvm -mtriple=riscv64-unknown-linux-gnu -mcpu=generic-rv64 -mfloat-abi=hard -mattr=+64bit,+a,+c,+d,+f,+m,+experimental-v"
...
func.save("lib.s")
cc.create_shared(path, ["lib.s"], cc="riscv64-unknown-linux-gnu-g++")
